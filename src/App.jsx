...
import buyLogo from './assets/buyLogoNew.png'
import sellLogo from './assets/sellLogoNew.png'
import 'primeicons/primeicons.css';
    ...
    <div className='the-main'>
      <div className="nav-bar">
        <div className='logo-div'>
          <img src={buyLogo} className='buy'></img>
          <h1 className='and'>&</h1>
          <img src={sellLogo} className='sell'></img>
        </div>
        ...
        <div className="nav-btns">
          ...
          <button className='nav-btn' onClick={() => !theUser ? alert('Please sign in first') : navigate('/sell')}>Sell A Product</button>
